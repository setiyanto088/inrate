...
class epg_config extends JA_Controller {
  ...
  public function index()
	...
	public function process_data(){
		...
		$token_proc =  $this->Anti_si($this->input->post('token_proc',true));
		
		$array_token = explode('|',$token_proc);
...
';
				...
				$myfile = fopen($folder."load_cdr_zte.sql", "w");
					$txt = 'LOAD DATA LOCAL INFILE "C:/xampp56/htdocs/inrate_ch/uploads/data.csv" INTO TABLE EPG_RAW1_TEMP_DEV FIELDS TERMINATED BY "," LINES TERMINATED BY "\n"  
