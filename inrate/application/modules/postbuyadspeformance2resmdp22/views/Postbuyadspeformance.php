		    ...
		    <script src="<?php echo $path;?>assets/ext/select2.min.js"></script>
			 ...
			 <link rel="stylesheet" type="text/css" href="<?php echo $path;?>assets/selectmm/virtual-select.min.css">
			 <script src="<?php echo $path;?>assets/selectmm/virtual-select.min.js"></script>
  <style>
							...
							<div class="col-lg-3" style="" id="">
								<div class="form-group">
									...
									<div class="select-wrapper">
									  ...
									  <div id='prog_selsss'>
											<select id="programss" multiple name="programss" placeholder="Product" data-search="false" data-silent-initial-value-set="true">
				  ...
				  var err_idx = 0;
				   ...
				   var err_idx_fin = 0;
					...
					if(err_idx_fin == 0 || $(this).data('real') == "2" || $(this).data('real') == "1" || $(this).data('real') == "0"){
						...
						$('#prog_selsss').html('');
						$('#prog_selsss').html('<select id="programss" multiple name="programss" placeholder="Product" data-search="false" data-silent-initial-value-set="true"><option value="all" Selected="selected" >All Program</option></select>');
