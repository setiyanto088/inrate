  ...
  public function list_product()
	{			
      ...
      $list = $this->postbuyadspeformance_model->_list_product($params);
 	  ...
 	  $html = '<select id="productss" multiple name="productss" placeholder="Product" data-search="false" data-silent-initial-value-set="true">';
	...
	{			
      ...
      $params['product']		= $this->input->post('valselect',true);
      $params['profile']		= $profile;        
	 ...
	 // <option value="all" Selected="selected" >All Program</option>';
	   ...
	   $html = '<select id="programss" multiple name="programss" placeholder="Product" data-search="false" data-silent-initial-value-set="true">';
